class ModToolsController < ApplicationController
  ...
  def update_user
    begin
      safe_params = params.require(:user).permit(:id, :email, :username, :details, :api_key, :set_count, :viewing_link, :password_reset_token, :quarantined, :pervert, :mascot, :flagged)
