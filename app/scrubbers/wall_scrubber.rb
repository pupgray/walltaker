class WallScrubber < Rails::Html::PermitScrubber
  def initialize
    ...
    self.attributes = %w( behavior bgcolor direction hspace scrollamount scrolldelay truespeed align valign vspace style src href class id width height alt land title rel colspan rowspan controls autoplay loop preload muted shape coords target )
  end
